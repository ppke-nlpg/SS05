...
c:\perl\bin\perl conlleval.pl < test.ioe1.wch100.merge > f-beta.from.ioe1.wch100
c:\perl\bin\perl conlleval.pl < test.from.ioe2.wch100 > f-beta.from.ioe2.wch100


c:\perl\bin\perl tovote3.pl > test.toIoe1.vote.3dr.wch100.merge
c:\perl\bin\perl conlleval.pl < test.toIoe1.vote.3dr.wch100.merge > f-beta.toIoe1.vote.3dr.wch100

c:\perl\bin\perl tovote5.pl > test.toIoe1.vote.5dr.wch100.merge
c:\perl\bin\perl conlleval.pl < test.toIoe1.vote.5dr.wch100.merge > f-beta.toIoe1.vote.5dr.wch100